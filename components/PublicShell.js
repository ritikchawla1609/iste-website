          ...
          <div className="footer-row-container">
            ...
            <div className="footer-contact-inline">
              ...
              <div className="footer-social-links-row">
                <a href="https://www.instagram.com/iste_cusc?igsh=MWc2cHE2cGc1N3AwOA==" target="_blank" rel="noopener noreferrer" className="footer-social-link-item" aria-label="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="footer-social-icon">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                  </svg>
                </a>
                <a href="https://www.linkedin.com/company/iste-student-chapter-chandigarh-university/" target="_blank" rel="noopener noreferrer" className="footer-social-link-item" aria-label="LinkedIn">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="footer-social-icon">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=iste.cusc@gmail.com" target="_blank" rel="noopener noreferrer" className="footer-social-link-item" aria-label="Email Support">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="footer-social-icon">
